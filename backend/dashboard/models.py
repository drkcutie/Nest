...
class Folders(models.Model):
    folderID = models.AutoField(primary_key=True)  # Add primary key
...
class Links(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='dashboard_links')  # Add related_name
