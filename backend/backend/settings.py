...
SECRET_KEY = 'django-insecure-5maxew19di+x^!p8y-&$26s9mshfccv&u!@_#@5@))$$utu#jo'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dashboard.context_processors.context',
            ],
        },
    },
]
...
AUTH_USER_MODEL = 'user_authentication_service.User'
